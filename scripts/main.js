;(function (window) {
  ...
  let texts = ['33','','很高兴遇见你','','有很多话想说','','但又不敢说出来','','想了好久','','还是决定说出来','','其实第一次见你','','我感到很奇妙','','那是一种','','莫名强烈的熟悉感','','这让我感到很恍惚','','也让我感到很开心','','就像是','','走了很久的路','','突然到家了','','我知道','','这样做很鲁莽','','但我还是想这样做','','因为','','我不想后悔','','有一段话这样说过','','这短短的一生','','我们最终都会失去','','不妨大胆一点','','爱一个人','','攀一座山','','追一个梦','','我想试一次','','起码做到心中无憾','','如果可以的话','','我想跟你做个约定','','下一年','','这个时候','','你还记得的话','','我想和你去一个地方','','嘻嘻！','','如果你忘了','','那也没关系','','我们，也算是朋友吧','','山海无盟','','锦书难托','','I MISS YOU',]
